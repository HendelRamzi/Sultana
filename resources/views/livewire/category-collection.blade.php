    ...
    <div class=" products_wrapper col-12 col-md-9 order-1 order-md-2">
        <div class="row">
            ...
            <div class="products_header section_spacing col-12 d-flex">
                ...
                <li>
                    <a href="{{route('website.collection', ['name' => $category->collection->name])}}" >Collection</a>
                </li>
                <li href="#" class="current">{{$category->name}}</li>
            </div>


            <div class="products_manipulation section_spacing col-12">
                <h2 class="category_big_title">{{$category->name}}</h2>
                <div class="d-flex gap-2">
                    <span class="product_number">{{count($category->products)}}</span><p> Produits trouvés</p>
                </div>
            </div>
            ...
            <div class=" products_list col-12">
                <div class="row gx-4">
                    ...
                    @foreach ($category->products as $product)
                            <div class=" product col-12 col-md-6 col-lg-4" wire:key={{$product->id}}>
                                <div class="d-flex flex-column gap-2 " style="position: relative">
                                    <div class="image-product">
                                        ...
                                        <div class="product__actions">
                                            <a wire:click="addToCart({{$product}})" style="cursor: pointer"> Ajouter au panier</a>
                                        </div>
                                    </div>

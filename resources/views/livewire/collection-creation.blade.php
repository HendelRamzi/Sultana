                        ...
                        <div class=" py-3 col-12">
                            ...
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">Creation d'une collection</h3>
                                </div>
                                <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nom de la collection</label>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button class="btn btn-primary" wire:click="addCollection">Ajouter</button>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                            </div>

                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('website.about')}}">Qui est Sultana ?</a>
                            </li>
                            <li>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <ul>
                            <li>
                                <a style="text-decoration: underline">contact@sultana.bio</a>
                            </li>
                            <li>Hasnaoui, Oran. Algerie.</li>
                            <li>056 11 38 333</li>
                        </ul>
                        <div class="follow-us">
                            <div class="row">
                                <div class="col-12">
                                    <h3 style="margin-bottom: 20px !important;">Suivez-nous sur </h3>
                                </div>
                                <div class="col">
                                    <a href="">
